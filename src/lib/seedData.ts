...
export const initialEbooks: EBook[] = [
  {
    ...
    format_file: 'epub',
    file_url: 'https://raw.githubusercontent.com/IDPF/epub3-samples/master/30/moby-dick/moby-dick.epub',
    onedrive_embed_url: 'https://onedrive.live.com/embed?resid=sample_matan_abu_syuja',
    tahun_terbit: '2024',
    jumlah_halaman: 124,
    bahasa: 'Bilingual',
  ...
  },
  {
    ...
    onedrive_embed_url: 'https://onedrive.live.com/embed?resid=sample_modul_pai_fased',
    tahun_terbit: '2024',
    jumlah_halaman: 210,
    bahasa: 'Indonesia',
    is_downloadable: true,
  ...
  },
  {
    ...
    format_file: 'mobi',
    file_url: 'https://onedrive.live.com/download?resid=sample_bulughul_maram',
    onedrive_embed_url: 'https://onedrive.live.com/embed?resid=sample_bulughul_maram',
    tahun_terbit: '2023',
    jumlah_halaman: 480,
    bahasa: 'Indonesia',
    is_downloadable: true,
  ...
  },
  {
    ...
    format_file: 'azw3',
    file_url: 'https://onedrive.live.com/download?resid=sample_safinatun_naja',
    onedrive_embed_url: 'https://onedrive.live.com/embed?resid=sample_safinatun_naja',
    tahun_terbit: '2023',
    jumlah_halaman: 85,
    bahasa: 'Arab',
    is_downloadable: true,
