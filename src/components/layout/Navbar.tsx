    ...
    <>
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between">
          ...
          {/* Brand */}
          <Link to="/" className="flex items-center gap-2.5 sm:gap-3 group shrink-0" aria-label="Beranda Aji Bagus Khoiri">
          ...
          {/* Desktop Navigation */}
          <nav className="hidden lg:flex items-center gap-0.5 bg-white/80 dark:bg-slate-900/80 backdrop-blur-md px-2.5 py-1 rounded-full border border-slate-200/80 dark:border-slate-800 shadow-sm" aria-label="Navigasi Utama">
            {navLinks.map((link) => {
          ...
          {/* Actions: Search, Dark Mode, Admin */}
          <div className="flex items-center gap-1.5 sm:gap-2">
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-2.5 py-1.5 rounded-xl text-slate-600 dark:text-slate-300 bg-slate-100/80 dark:bg-slate-800/80 hover:bg-slate-200 dark:hover:bg-slate-700 border border-slate-200/60 dark:border-slate-700/60 transition-colors"
            >
              <Search className="w-4 h-4 text-brand-600 dark:text-brand-400" aria-hidden="true" />
              <span className="hidden sm:inline text-xs font-medium text-slate-500">Cari...</span>
              <kbd className="hidden sm:inline-block px-1.5 py-0.5 text-[10px] font-mono font-bold bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded text-slate-400">
                ⌘K
              </kbd>
            </button>
            ...
            >
              {isDark ? <Sun className="w-4 h-4 text-amber-400" aria-hidden="true" /> : <Moon className="w-4 h-4 text-slate-600" aria-hidden="true" />}
            </button>
